...
\includegraphics[width=50mm,scale=0.5]{app1}
...
\includegraphics[width=50mm,scale=0.5]{Panorama}
...
%subsubsection 6
\subsection{Specification of Treasure Hunt}
\includegraphics[width=50mm,scale=0.5]{Treasure_hunter}

\begin{enumerate}
\item Upon clicking the Treasure Hunt icon, users will search for the moving 3D Cube object. 
...
\includegraphics[width=50mm,scale=0.5]{Volume}
...
\includegraphics[width=50mm,scale=0.5]{Preference}
